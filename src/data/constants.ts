...
export const SKILLS: Record<SkillNames, Skill> = {
  [SkillNames.JS]: {
    ...
    name: "js",
    label: "JavaScript",
    shortDescription: "Visualizing data dynamically and writing custom scripts 📊✨",
    color: "#f0db4f",
  ...
  [SkillNames.TS]: {
    ...
    name: "ts",
    label: "TypeScript",
    shortDescription: "Type-safe data pipelines are the best pipelines 🔒📊",
    color: "#007acc",
  ...
  [SkillNames.HTML]: {
    ...
    name: "html",
    label: "HTML",
    shortDescription: "The skeleton for my data visualization dashboards 💀📈",
    color: "#e34c26",
  ...
  [SkillNames.CSS]: {
    ...
    name: "css",
    label: "CSS",
    shortDescription: "Styling charts and graphs to look absolutely bussin' 💁‍♂️🔥",
    color: "#563d7c",
  ...
  [SkillNames.REACT]: {
    ...
    name: "react",
    label: "React",
    shortDescription: "Building interactive data dashboards that hit different 📉👀",
    color: "#61dafb",
  ...
  [SkillNames.VUE]: {
    ...
    name: "vue",
    label: "Vue",
    shortDescription: "Smooth reactive interfaces for custom data reporting 🟢😌",
    color: "#41b883",
  ...
  [SkillNames.NEXTJS]: {
    ...
    name: "nextjs",
    label: "Next.js",
    shortDescription: "Server-side rendering those heavy data tables 👑📜",
    color: "#fff",
  ...
  [SkillNames.TAILWIND]: {
    ...
    name: "tailwind",
    label: "Tailwind",
    shortDescription: "Making data viz look beautiful with utility classes 🌪️🔥",
    color: "#38bdf8",
  ...
  [SkillNames.NODEJS]: {
    ...
    name: "nodejs",
    label: "Node.js",
    shortDescription: "Backend scripting for automated data extraction and APIs 🔙🔚",
    color: "#6cc24a",
  ...
  [SkillNames.EXPRESS]: {
    ...
    name: "express",
    label: "Express",
    shortDescription: "Serving up data APIs real quick! 🚂💨",
    color: "#fff",
  ...
  [SkillNames.POSTGRES]: {
    ...
    name: "postgres",
    label: "PostgreSQL",
    shortDescription: "Where I write complex SQL queries that are god tier 🐘💯",
    color: "#336791",
  ...
  [SkillNames.MONGODB]: {
    ...
    name: "mongodb",
    label: "MongoDB",
    shortDescription: "Flexin' with unstructured NoSQL data drops 💪🍃",
    color: "#336791",
  ...
  [SkillNames.GIT]: {
    ...
    name: "git",
    label: "Git",
    shortDescription: "Version controlling my Jupyter notebooks and SQL scripts 🕵️‍♂️🔄",
    color: "#f1502f",
  ...
  [SkillNames.GITHUB]: {
    ...
    name: "github",
    label: "GitHub",
    shortDescription: "Where I push my data models and analysis projects 🐙",
    color: "#000000",
  ...
  [SkillNames.PRETTIER]: {
    ...
    name: "prettier",
    label: "Prettier",
    shortDescription: "Making my Python and SQL code look clean 🧹✨",
    color: "#f7b93a",
  ...
  [SkillNames.NPM]: {
    ...
    name: "npm",
    label: "NPM",
    shortDescription: "Installing packages for data viz libraries 📦💯",
    color: "#fff",
  ...
  [SkillNames.FIREBASE]: {
    ...
    name: "firebase",
    label: "Firebase",
    shortDescription: "Tracking user events and raw analytics data 🔥👌",
    color: "#ffca28",
  ...
  [SkillNames.WORDPRESS]: {
    ...
    name: "wordpress",
    label: "WordPress",
    shortDescription: "Where I publish my data analysis case studies 🧓👴",
    color: "#007acc",
  ...
  [SkillNames.LINUX]: {
    ...
    name: "linux",
    label: "Linux",
    shortDescription: "Running data pipelines and Cron jobs smoothly 🔓🙌",
    color: "#fff",
  ...
  [SkillNames.DOCKER]: {
    ...
    name: "docker",
    label: "Docker",
    shortDescription: "Containerizing ML models so they work everywhere 🐳🔥",
    color: "#2496ed",
  ...
  [SkillNames.NGINX]: {
    ...
    name: "nginx",
    label: "NginX",
    shortDescription: "Routing traffic to my deployed data dashboards 🚗💨",
    color: "#008000",
  ...
  [SkillNames.AWS]: {
    ...
    name: "aws",
    label: "AWS",
    shortDescription: "Hosting massive data lakes in the cloud 🌐👨‍💻",
    color: "#ff9900",
  ...
  [SkillNames.VIM]: {
    ...
    name: "vim",
    label: "Vim",
    shortDescription: "Editing CSV files directly in the terminal 🚪🏃",
    color: "#e34c26",
  ...
  [SkillNames.VERCEL]: {
    ...
    name: "vercel",
    label: "Vercel",
    shortDescription: "Deploying data apps faster than you can say 'query' 🚀🌿",
    color: "#6cc24a",
