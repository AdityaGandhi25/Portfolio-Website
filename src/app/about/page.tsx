...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "adityagandhingp@gmail",
    href: "mailto:adityagandhingp@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/adityagandhi25042006/",
    content: "/adityagandhi25042006",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/AdityaGandhi25",
    content: "/AdityaGandhi25",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Aditya Gandhi</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Aditya, a 2nd-year Computer Science student aiming to become a Data Analyst. 
              I am passionate about uncovering insights from data, building analytical models, and 
              solving real-world problems with data-driven approaches. I bring strong analytical skills, effective communication, 
              and a continuous learning mindset to every project.
            </p>
            <p className="mb-10">
